...
export declare const setupOrmApp: (models_and_routes: Map<string, any>, mergeOrmMw: Partial<IOrmMwConfig>, mergeRoutesConfig: Partial<IRoutesMergerConfig>, callback: (err: Error, app?: import("connect").Server | http.Server | import("https").Server | restify.Server | undefined, orms_out?: IOrmsOut | undefined) => void) => void;
